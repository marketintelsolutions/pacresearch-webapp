export const directorsData = [
...

  {
    ...
    role: "DIRECTOR",
    desc: [
      "Nentok Gomwalk is a seasoned finance professional with over 15 years of experience, currently serving as Group Head of Finance, Investment, and Strategy at Pan-African Capital Holdings. He has held prominent roles including Group CFO at Comercio Partners and Head of Finance & Treasury at GTI Investment Group. Nentok has a robust background in financial strategy, administration, and treasury management, with a career spanning firms like Eurocomm Securities and Lister Oil. He holds a BBA from Ahmadu Bello University and is a certified ACCA member, reflecting his strong expertise in accounting and finance.",
    ],
  },
  {
    image: "fatai",
    ...
    desc: [
      "Fatai Asimi is a distinguished research professional with a master's degree from the University of Ibadan and holds an associate membership with the Institute of Chartered Accountants of Nigeria (ICAN). With an extensive background as a research and financial analyst, Fatai possesses an exceptional understanding of the Nigerian business landscape.",

      "His illustrious career spans over 20 years within the Nigerian financial services sector, showcasing his multifaceted expertise as an economic and policy analyst, business information specialist, investment analyst, and strategy and planning manager. Fatai excels in furnishing precise information and astute analyses that empower businesses. His proficiency lies in guiding organizations and individuals toward informed investment decisions harmonized with the prevailing external economic conditions.",

      "Fatai’s contributions include conducting exhaustive research and crafting comprehensive reports encompassing various industries in Nigeria. His exemplary work led to his selection by the United States Department of State (Bureau of Educational and Cultural Affairs) for the International Visitor Leadership Program in August 2010, focusing on the theme 'Emerging Markets and the Global Economy",
    ],
  },
];
